...
public class Reserva {
	...
	public String toString() {
		return "fecha: " + this.fecha + "/n" + "estado de pago: " + this.pagado + "/n" + "cantidad de personas: "
				+ this.cantidadPersona + "/n" + "tour: " + this.tourReservado.getNombreComercial() + "/n" + "cliente: "
				+ this.clienteReserva;
	}
